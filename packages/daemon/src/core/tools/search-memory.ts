...
export const searchMemoryTool = tool({
    ...
    inputSchema: z.object({
        category: z.string().describe('Broad namespace mapping to search this knowledge block from the Cognitive Map (e.g., "JLike" or "Architecture"). Must perfectly match one of your known Categories.'),
